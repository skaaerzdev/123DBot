...
const cases = {
    ...
    case1: {
        ...
        items: [
            ...
            { name: '10% Coin Boost (24h)', type: 'coins', chance: 4, roleId: process.env.CASE1_GRADIENT_ROLE_3_ID, roleName: 'HoneyComb' },
    ...
    case2: {
        ...
        items: [
            ...
            { icon: '<:123dcoin:1342698565780242475>',name: '20,000 Coins', type: 'coins', chance: 8 },
            { icon: '<:123dcoin:1342698565780242475>',name: '15,000 Coins', type: 'coins', chance: 10 },
            { icon: '<:123dcoin:1342698565780242475>',name: '4,000 Coins', type: 'coins', chance: 10 },
            { icon: '<:123dcoin:1342698565780242475>',name: '2,000 Coins', type: 'coins', chance: 15 },
            { icon: '<:123dcoin:1342698565780242475>',name: '1,000 Coins', type: 'coins', chance: 20 },
            { icon: '<:123dcoin:1342698565780242475>',name: '😔 Nothing', type: 'coins', chance: 28 },
        ],
    },
    ...
    case3: {
        ...
        items: [
            ...
            { icon: '<:123dcoin:1342698565780242475>',name: '😔 Nothing', type: 'coins', chance: 30 },
        ],
    },
    ...
    case4: {
        ...
        items: [
            ...
            { icon: '<:123dcoin:1342698565780242475>',name: '50,000 Coins', type: 'coins', chance: 4 },
            { icon: '<:123dcoin:1342698565780242475>',name: '10% Coin Boost (24h)', type: 'coins', chance: 4 },
            { icon: '<:123dcoin:1342698565780242475>',name: '30,000 Coins', type: 'coins', chance: 8 },
            { icon: '<:123dcoin:1342698565780242475>',name: '15,000 Coins', type: 'coins', chance: 10 },
            { icon: '<:123dcoin:1342698565780242475>',name: '5,000 Coins', type: 'coins', chance: 10 },
            { icon: '<:123dcoin:1342698565780242475>',name: '2,000 Coins', type: 'coins', chance: 15 },
            { icon: '<:123dcoin:1342698565780242475>', name: '1,000 Coins', type: 'coins', chance: 20 },
            { icon: '<:123dcoin:1342698565780242475>', name: '😔 Nothing', type: 'coins', chance: 24 },
        ],
    },
    ...
    case6: {
        ...
        items: [
            ...
            { icon: '<:123dcoin:1342698565780242475>',name: '25,000 Coins', type: 'coins', chance: 2,},
            { icon: '<:123dcoin:1342698565780242475>',name: '10,000 Coins', type: 'coins', chance: 4 },
            ...
            { icon: '<:123dcoin:1342698565780242475>',name: '4,500 Coins', type: 'coins', chance: 9 },
            { icon: '<:123dcoin:1342698565780242475>',name: '3,500 Coins', type: 'coins', chance: 15 },
            { icon: '<:123dcoin:1342698565780242475>',name: '2,500 Coins', type: 'coins', chance: 25 },
            { icon: '<:123dcoin:1342698565780242475>',name: '1,500 Coins', type: 'coins', chance: 30 },
        ],
    },
    ...
    case7: {
        ...
        items: [
            { icon: '<:GodIsGood:1370500908458311681>', name: '<@&1500503360242057306>', type: 'role', chance: 1, roleId: process.env.CASE1_GRADIENT_ROLE_1_ID, roleName: 'Big Dawg' },
            { name: '<@&1404608744523956307>', type: 'coins', chance: 19, roleId: process.env.CASE7_GRADIENT_ROLE_1_ID, roleName: 'Big Dawg'},
            { name: '<@&1404608746986016779>', type: 'coins', chance: 20, roleId: process.env.CASE7_GRADIENT_ROLE_2_ID, roleName: 'Big Dawg'},
            { name: '<@&1404608749754253354>', type: 'coins', chance: 20, roleId: process.env.CASE7_GRADIENT_ROLE_3_ID, roleName: 'Big Dawg'},
            { name: '<@&1404610728400261201>', type: 'coins', chance: 20, roleId: process.env.CASE7_GRADIENT_ROLE_4_ID, roleName: 'Big Dawg'},
            { name: '<@&1404610805583839395>', type: 'coins', chance: 20, roleId: process.env.CASE7_GRADIENT_ROLE_5_ID, roleName: 'Big Dawg'},
        ],
    },
};
